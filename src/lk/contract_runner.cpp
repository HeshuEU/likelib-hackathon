...
namespace lk {
    class ContractRunner::ContractRunnerImpl : public evmc::Host {
    public:
        ContractRunnerImpl(base::Bytes code, lk::Core &core, const bc::Transaction& associated_tx,
                const bc::Block &associated_block,
                           lk::AccountManager &account_manager, lk::CodeManager &code_manager)
                : _core{core}, _associated_tx{associated_tx}, _associated_block{associated_block}, _account_manager{account_manager},
                  _code_manager{code_manager}, _smart_contract{std::move(code)}, _vm{vm::Vm::load(*this)} {}
...
ContractRunner::ContractRunner(base::Bytes code, Core &core, const bc::Transaction& associated_tx, const bc::Block &associated_block,
                               AccountManager &account_manager, CodeManager &code_manager)
        : _impl{std::make_unique<ContractRunnerImpl>(std::move(code), core, associated_tx, associated_block, account_manager,
                                                     code_manager)}
{}
