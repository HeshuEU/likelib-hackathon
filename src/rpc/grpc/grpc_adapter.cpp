    ...
    namespace grpc {
        ...
        ::grpc::Status Adapter::create_contract(::grpc::ServerContext *context,
            ...
            try {
                ...
                _service->transaction_create_contract(amount, from_address, creation_time, gas, contract_code, init,
                                                      sign);
        ...
        ::grpc::Status Adapter::message_call(::grpc::ServerContext *context,
            ...
            try {
                ...
                std::tie(status, contract_response, least_gas) =
                        _service->transaction_message_call(amount, from_address, to_address, creation_time, gas, data,
                                                           sign);
