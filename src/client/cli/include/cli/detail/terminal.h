...
class Terminal
{
  public:
    ...
    {
        out << beforeInput << std::string(position, '\b') << newLine << afterInput << std::flush;
        ...
        switch (k.first) {
            ...
            case KeyType::right:
                if (position < currentLine.size()) {
                    out << beforeInput << currentLine[position] << afterInput << std::flush;
                    ++position;
                }
                break;
            case KeyType::ret: {
            ...
            case KeyType::ascii: {
                ...
                if (c == '\t')
                    ...
                    out << std::string(currentLine.begin() + pos, currentLine.end()) << afterInput;
            ...
            case KeyType::end: {
                ...
                out << beforeInput << std::string(currentLine.begin() + pos, currentLine.end()) << afterInput
                    << std::flush;
                position = currentLine.size();
                break;
            }
