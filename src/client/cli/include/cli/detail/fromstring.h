...
template<>
inline signed char from_string(const std::string& s)
{
    return detail::signed_from_string<signed char>(s);
}

template<>
inline short int from_string(const std::string& s)
{
    return detail::signed_from_string<short int>(s);
}

template<>
inline int from_string(const std::string& s)
{
    return detail::signed_from_string<int>(s);
}

template<>
inline long int from_string(const std::string& s)
{
    return detail::signed_from_string<long int>(s);
}

template<>
inline long long int from_string(const std::string& s)
{
    return detail::signed_from_string<long long int>(s);
}

// unsigned

template<>
inline unsigned char from_string(const std::string& s)
{
    return detail::unsigned_from_string<unsigned char>(s);
}

template<>
inline unsigned short int from_string(const std::string& s)
{
    return detail::unsigned_from_string<unsigned short int>(s);
}

template<>
inline unsigned int from_string(const std::string& s)
{
    return detail::unsigned_from_string<unsigned int>(s);
}

template<>
inline unsigned long int from_string(const std::string& s)
{
    return detail::unsigned_from_string<unsigned long int>(s);
}

template<>
inline unsigned long long int from_string(const std::string& s)
{
    return detail::unsigned_from_string<unsigned long long int>(s);
}
...
inline T from_string(const std::string& s)
{
    ...
    if (!(interpreter << s) || !(interpreter >> result) || !(interpreter >> std::ws).eof())
        throw bad_conversion();
