...
BOOST_AUTO_TEST_CASE(block_constructor1)
{
    ...
    BOOST_CHECK(!block_tx_set.find(bc::Transaction(trans2.getFrom(),
                                                   trans2.getTo(),
                                                   146987,
                                                   0,
                                                   trans2.getTimestamp(),
                                                   bc::Transaction::Type::MESSAGE_CALL,
                                                   base::Bytes{})));
    BOOST_CHECK(!block_tx_set.find(bc::Transaction(trans4.getFrom(),
                                                   trans4.getTo(),
                                                   trans4.getAmount(),
                                                   0,
                                                   base::Time::now(),
...
BOOST_AUTO_TEST_CASE(block_sets)
{
    ...
    bc::Transaction new_trans{ bc::Address(base::generateKeys().first),
                               bc::Address(base::generateKeys().first),
                               67805678,
                               0,
                               base::Time(),
...
BOOST_AUTO_TEST_CASE(block_add_transaction)
{
    bc::Block block(118,
                    ...
                    miner_address,
                    getTestSet());
    bc::Transaction new_trans1{ bc::Address(base::generateKeys().first),
                                bc::Address(base::generateKeys().first),
                                67805678,
                                0,
                                base::Time(),
                                bc::Transaction::Type::MESSAGE_CALL,
                                base::Bytes{} };
    bc::Transaction new_trans2{ bc::Address(base::generateKeys().first),
                                bc::Address(base::generateKeys().first),
                                2078911,
                                0,
                                base::Time(),
