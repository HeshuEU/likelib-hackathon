...
BOOST_AUTO_TEST_CASE(sha1_hash)
{
    ...
    BOOST_CHECK_EQUAL(sha1_1.getBytes().toHex(), hex_str1);
    ...
    BOOST_CHECK_EQUAL(sha1_2.getBytes().toHex(), hex_str2);
    ...
    BOOST_CHECK_EQUAL(sha1_3.getBytes().toHex(), hex_str3);
    ...
    BOOST_CHECK_EQUAL(sha1_4.getBytes().toHex(), hex_str4);
}
