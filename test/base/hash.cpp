...
{
    auto sha256_1 = base::Sha256::calcSha256(base::Bytes{0x4c, 0x49, 0x4b, 0x45, 0x4c, 0x49, 0x42, 0x9, 0x32, 0x2e, 0x30});
    ...
    auto sha256_2 =  base::Sha256::calcSha256(base::Bytes("likelib.2"));
    ...
    auto sha256_3 = base::Sha256::calcSha256(base::Bytes("it's third test"));
    ...
    auto sha256_4  = base::Sha256::calcSha256(base::Bytes(""));
...
{
    auto sha1_1 =  base::Sha1::calcSha1(base::Bytes{0x4c, 0x49, 0x4b, 0x45, 0x4c, 0x49, 0x42, 0x9, 0x32, 0x2e, 0x30});
    ...
    auto sha1_2 =  base::Sha1::calcSha1(base::Bytes("likelib.2"));
    ...
    auto sha1_3 =  base::Sha1::calcSha1(base::Bytes("it's third test"));
    ...
    auto sha1_4 =  base::Sha1::calcSha1(base::Bytes(""));
